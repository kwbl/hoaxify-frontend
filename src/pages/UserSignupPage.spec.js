...
describe("UserSignupPage", () => {
  ...
  describe("interactions", () => {
    ...
    it("does not thrown exception when clicking the button and actions are not provided in the props", () => {
      setupForSubmit()
    ...
    it("does not allow user to click the Sign Up button when there is pending api call", () => {
      const actions = {
    ...
    it("display spinner when there is a pending api call", () => {
      const actions = {
        postSignup: mockAsyncDelayed()
      }
